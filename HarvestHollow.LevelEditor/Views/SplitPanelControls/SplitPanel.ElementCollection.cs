...
public partial class SplitPanel
{
    public class ElementCollection : IList<UIElement>, IList
    {
        ...
        public static UIElement s_CastToElement(object? input)
        {
            ...
            UIElement? element = (input as UIElement) ?? throw new InvalidCastException(String.Format(_elementTypeErrorMessage, typeof(UIElement)));
        ...
        private void internalReplace(int index, UIElement element)
        {
            ...
            double size = GetSize(replaceElement);
        ...
        object? IList.this[int index]
        {
            ...
            set
            {
                ...
                this[index] = s_CastToElement(value);
            }
        }
