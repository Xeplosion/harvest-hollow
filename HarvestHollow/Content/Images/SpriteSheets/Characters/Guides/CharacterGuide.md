...
Example:
"Char_A_p1_1OUT_PFPN_v01.png" below is an example explaning each naming element:

--------------------------------------------------------------------------------------

Char
This is a character sheet. All character sheets begin with this.

A
Character type A. Currently the only character option but should be scalable for future use.
...
There is a "HoeAndAxe.png" image included in the archive that can help you make your own replacement tools.